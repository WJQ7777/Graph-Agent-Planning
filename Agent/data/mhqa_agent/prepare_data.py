...
import datasets
from sys_prompts import (SR1_SYS_PROMPT, ENHANCED_MHQA_PROMPT, MHQA_PROMPT_ONE_SHOT,
                        WEB_AGENT_PROMPT)
...
def main():
    ...
    try:
        ...
        output_path = os.path.join(args.output, f"{base_filename}_one_shot.parquet")
